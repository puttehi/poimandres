...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Constant ctermbg=NONE ctermfg=13 cterm=NONE guibg=NONE guifg=#ad7fa8 gui=NONE
    hi Error ctermbg=NONE ctermfg=9 cterm=NONE guibg=NONE guifg=#ef2929 gui=NONE
    hi Identifier ctermbg=NONE ctermfg=3 cterm=NONE guibg=NONE guifg=#c4a000 gui=NONE
    ...
    hi Statement ctermbg=NONE ctermfg=4 cterm=NONE guibg=NONE guifg=#3465a4 gui=NONE
    ...
    hi Type ctermbg=NONE ctermfg=9 cterm=NONE guibg=NONE guifg=#ef2929 gui=NONE
...
let g:terminal_ansi_colors = [ '#262a2c', '#cc0000', '#4e9a06', '#c4a000', '#3465a4', '#75507b', '#06989a', '#d3d7cf', '#555753', '#ef2929', '#8ae234', '#fce94f', '#729fcf', '#ad7fa8', '#34e2e2', '#eeeeec', ]
