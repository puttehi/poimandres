...
function M.get(config)
    ...
    theme = {
        ...
        -- Cursor = {},
        CursorColumn = { bg = groups.panel_float },
        -- CursorIM = {},
        CursorLine = { bg = groups.panel_float },
        ...
        htmlH1 = { fg = groups.headings.h5, style = 'bold' },
        htmlH2 = { fg = groups.headings.h5, style = 'bold' },

        -- mkdHeading = { fg = c.orange, style = "bold" },
        -- mkdCode = { bg = c.terminal_black, fg = c.fg },
        mkdCodeDelimiter = { bg = groups.background, fg = p.text },
        ...
        markdownH1 = { fg = groups.headings.h6, style = 'bold' },
        markdownH2 = { fg = groups.headings.h6, style = 'bold' },
        markdownH3 = { fg = groups.headings.h6, style = 'bold' },
        markdownH4 = { fg = groups.headings.h6, style = 'bold' },
        ...
        ['@variable.builtin'] = { fg = groups.headings.h6 },
        ['@constant.builtin'] = { fg = groups.headings.h6 },
        -- TSConstMacro = {},
        ...
        ['@keyword.function'] = { fg = groups.headings.h6 },
        ['@keyword.operator'] = { fg = groups.headings.h5 },
